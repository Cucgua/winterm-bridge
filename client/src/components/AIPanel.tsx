                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {e.duration_ms !== undefined && e.duration_ms > 0 && (
                      <span className="text-xs text-text-secondary/60">{e.duration_ms}ms</span>
                    )}
                  </div>
                  {(e.tag || e.description) && (
                  ...
                  {isExpanded && (
                    <div className="mt-1.5 space-y-0.5 text-xs text-text-secondary/60">
                      <div>type: <span className="text-text-primary/95 font-mono">{e.event_type}</span></div>
                      {e.action_sig && <div>action: <span className="text-text-primary/95 font-mono">{e.action_sig}</span></div>}
                      {e.action_kind && <div>kind: <span className="text-text-primary/95">{e.action_kind}</span></div>}
                      ...
                      {e.reasoning && <div>summary: <span className="text-text-primary/95">{e.reasoning}</span></div>}
