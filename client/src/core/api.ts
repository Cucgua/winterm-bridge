// Use Tauri's HTTP plugin fetch — routes through Rust's reqwest, bypassing
// WebView mixed-content restrictions. This allows connecting to http:// backends
// from a secure-context WebView (origin: https://tauri.localhost).
